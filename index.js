...
// Isku-xirka MongoDB (Hubi inuu xogtaada yahay)
...
mongoose.connect(mongoURI)
    .then(() => console.log("✅ Database-ka Nawawi waa Live"))
    .catch(err => console.error("❌ Cilad baa ka jirta DB-ga:", err));

// Schema-ga Ardayga (Waxba lagama jarin)
...
// Soo saarista Ardayda (Halkan ayaa xallinaya fariinta "ma helin")
...
// Kaydinta Xogta (Add Student, Attendance, Exams)
...
app.listen(PORT, '0.0.0.0', () => console.log(`🚀 Nidaamku wuxuu ka shaqaynayaa Port: ${PORT}`));